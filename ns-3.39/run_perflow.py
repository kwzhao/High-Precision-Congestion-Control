...
FIXED_WIN {fwin}
BASE_RTT {base_rtt}
MAX_INFLIGHT_FLOWS {max_inflgiht_flows}
"""
if __name__ == "__main__":
    ...
    config_specs="_s%d_i%d"%(seed, max_inflgiht_flows)
