...
gdb --args ./waf --run 'scratch/third /data2/lichenni/path_tc_cc/shard0_nflows1_nhosts3/config_topo-pl-3-10-10000_flows_s3.txt'
...
./ns3 run 'scratch/third /data2/lichenni/path_tc_cc/shard0_nflows1_nhosts3/config_topo-pl-3-10-27000_flows_s10.txt' --gdb
...
NS_LOG="Ipv4EndPointDemux" ./ns3 run 'scratch/third /data2/lichenni/path_tc_cc/shard0_nflows1_nhosts3/config_topo-pl-3-10-10000_flows_s0.txt' > test.log 2> test.log
...
./waf --run 'scratch/third /data2/lichenni/path_perflow_test/shard0_nflows20000_nhosts3_lr10Gbps/config_topo-pl-3_flows_s0.txt' > test.log 2> test.log

./trace_reader /data2/lichenni/path_perflow_test/shard0_nflows20000_nhosts3_lr10Gbps/mix_topo-pl-3_s0.tr > /data2/lichenni/path_perflow_test/shard0_nflows20000_nhosts3_lr10Gbps/mix_topo-pl-3_s0.log
